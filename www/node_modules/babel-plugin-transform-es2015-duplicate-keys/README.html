...
object literals with duplicate keys.</p>
<h2>Installation</h2><pre><code class="language-sh">$ npm install babel-plugin-transform-es2015-duplicate-keys
</code></pre>
...
<h3>Via CLI</h3><pre><code class="language-sh">$ babel --plugins transform-es2015-duplicate-keys script.js
</code></pre>
